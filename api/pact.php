...
<head>
    <meta charset="UTF-8">
    <title>使用协议</title>
    <link rel="stylesheet" href="./pact.css">
</head>
<body>
    <div class="pact-container">
        <h1 class="pact-title">使用协议</h1>
        ...
        <div class="pact-section">
            <h2>二、使用限制</h2>
            <ol>
                <li>允许商用：如需商用代码，请提前联系开发者说明具体用途，经确认后可用于商业用途，包括但不限于：
                    <ol type="a">
                        <li>直接销售或收费分发</li>
                        <li>嵌入商业产品或服务</li>
                        <li>为第三方提供收费服务</li>
                ...
                <li>二次开发要求：允许修改后端 PHP 源代码，但需保留以下条件：
                    <ol type="a">
                        <li>显著标注原项目地址</li>
                        <li>衍生作品仍需遵循本协议全部条款</li>
                    </ol>
                </li>
                <li>合法使用：禁止用于任何非法活动，包括但不限于攻击他人网络、传播恶意软件等。</li>
            </ol>
        </div>
        <div class="pact-section">
            <h2>三、免责声明</h2>
            <ol>
                ...
                <li>开发者不对使用或无法使用本软件导致的任何直接、间接损失承担责任。</li>
            </ol>
        </div>
        <div class="pact-section">
            <h2>四、版权信息</h2>
